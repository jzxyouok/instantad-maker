    ...
    <div v-show="seen">
        <div v-show="item_data && item_data.type">
            ...
            <div v-if="item_data.type=='21'">
                <div>按钮背景色：
                    <input type="text" v-model=item_data.btnBgColorTheme />
                </div>
                <div>跳转地址：
                    <input type="text" v-model=item_data.btnJumpUrl />
                </div>
            </div>
            ...
            <div v-if="item_data.type=='62'">
                <div>面包vid:<input type="text" v-model=item_data.videoVid />
                </div>
            </div>
        ...
        <div v-show="item_data && item_data.componentItemList">
            ...
            <div>背景色：<input type="text" v-model="item_data.backgroundColor" />
            </div>
        </div>
    </div>
</template>
